...
import RegisterService from '../views/register-service.vue'
...
const routes = [
  ...
  { path: '/register-service', name: 'RegisterService', component: RegisterService, meta: { requiresAuth: true, memberOnly: true }}
]
